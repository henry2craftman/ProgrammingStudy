...
public class MainClass
{
    ...
    public static void Main()
    {
        ...
        //person1.name = "신태욱"; // 변수의 초기화, Variable Initialization
        //person1.Introduce();

        // 실습5. 클래스 생성자를 사용하여 5명의 사람 클래스 인스턴싱 해봅니다.
        Person person2 = new Person("신태욱", 30, 1);
        Person person3 = new Person("김태우", 40, 2);
        Person person4 = new Person("강호동", 50, 3);
        Person person5 = new Person("유재석", 40, 4);
        Person person6 = new Person("김한길", 50, 5);
        ...
        while(isRunning)
        {
            ...
            for(int status = 0; status < statusNumber; status++)
            {
                ...
                {
                    case 0:
                        Console.WriteLine("책 이름을 입력해 주세요.");
